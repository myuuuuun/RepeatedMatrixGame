...
if __name__ == '__main__':
    ...
    # 読み込み
    #df = pd.read_csv('../../experiment3/contest5/data/set_result.csv', index_col=[0, 1], header=[0, 1])
    df = pd.read_csv('../../experiment3-appendix1/contest5/data/set_result.csv', index_col=[0, 1], header=[0, 1])
    ...
    #plt.title("平均利得の推移（自分との対戦無し）")
    plt.title("平均利得の推移（自分との対戦有り）")
